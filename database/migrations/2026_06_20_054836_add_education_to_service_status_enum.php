...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE registrations MODIFY COLUMN service_status ENUM('registered','triage','in_consultation','completed','cancelled') NOT NULL DEFAULT 'registered'");
    }
};
