            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0" name="dosage_per_unit" class="form-control @error('dosage_per_unit') is-invalid @enderror" value="{{ old('dosage_per_unit') }}" placeholder="Contoh: 500 (untuk 500mg/tablet)">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" min="0" name="minimum_stock" class="form-control @error('minimum_stock') is-invalid @enderror" value="{{ old('minimum_stock') }}" placeholder="10">
