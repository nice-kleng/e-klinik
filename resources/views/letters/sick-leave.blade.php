...
<body>
    ...
    <p style="text-align:center">Nomor: SK/{{ $registration->registration_number }}</p>
    ...
    <div class="content">
        ...
        <p>Telah diperiksa dan dinyatakan sakit, sehingga perlu istirahat selama <strong>{{ $summary->sick_leave_days }} hari</strong>, terhitung mulai tanggal {{ $summary->sick_leave_from?->format('d/m/Y') }} sampai dengan {{ $summary->sick_leave_to?->format('d/m/Y') }}.</p>
