...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('doctors.show', $doctor) }}" class="btn btn-outline-secondary">Kembali</a>
    </div>
    ...
    <form method="POST" action="{{ route('doctors.update', $doctor) }}">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $doctor->code) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="polyclinic_id" class="form-select @error('polyclinic_id') is-invalid @enderror" required>
                            ...
                            @foreach($polyclinics as $poly)
                                <option value="{{ $poly->id }}" {{ old('polyclinic_id', $doctor->polyclinic_id) == $poly->id ? 'selected' : '' }}>{{ $poly->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="specialist" class="form-control @error('specialist') is-invalid @enderror" value="{{ old('specialist', $doctor->specialist) }}">
                        @error('specialist') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">No. SIP</label>
                        <input type="text" name="sip_number" class="form-control @error('sip_number') is-invalid @enderror" value="{{ old('sip_number', $doctor->sip_number) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $doctor->is_active) ? 'checked' : '' }}>
            ...
            <div class="card-footer bg-white d-flex justify-content-end gap-2">
                <a href="{{ route('doctors.show', $doctor) }}" class="btn btn-outline-secondary">Batal</a>
